    ...
    return (
        <Scroll html>
            <div>
                ...
                <Section>
                    <h3 className="text-2xl md:text-6xl text-black">Project Water (Working title)</h3>
                    <ul className="text-lg md:text-3xl text-black">
                ...
                <Section>
                    <h1 className="text-2xl md:text-5xl text-black">Contact me at: ershowpeter@gmail.com</h1>
                    ...
                    <p className="text-lg md:text-5xl text-black mt-4">Credits:</p>
                    <ul className="text-base md:text-3xl text-black">
                    ...
                    <p className="text-base md:text-3xl text-black mt-4">All projects listed on the page are used purely for educational purposes and were never used for commercial purposes.</p>
                </Section>
            </div>
        </Scroll>
    );
