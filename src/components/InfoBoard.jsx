            ...
            <div className={'mt-16'}>
                ...
                <Section>
                    ...
                    <ul className="text-3xl sm:text-3xl text-white">
                        ...
                        <li>Compared to many other certification projects, this one was extended by me in many places, I added an easter egg with football and increased complexity of the platforms</li>
                    </ul>
                </Section>
